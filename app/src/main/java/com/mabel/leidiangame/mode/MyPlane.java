package com.mabel.leidiangame.mode;
...
import com.mabel.leidiangame.MainView;
import com.mabel.leidiangame.R;
import com.mabel.leidiangame.mode.Bullet;
import com.mabel.leidiangame.mode.Bullet2;
...
public class MyPlane extends GameObject {
	...
	public MyPlane(MainView mainView, Resources resources) {
		super(resources);
		initBitmap();
		this.speed = 8;
